                    ...
                    <div class="row">
                            ...
                            <article class="home-post text-center">
                                <div class="post-thumb">
                                    <a href="./blog-single.html">
                                        <img src="{{asset('frontend/images/blog/1/1.jpg')}}" class="img-responsive" alt=""/>
                        ...
                        <div class="col-md-4 col-sm-4">
                            <article class="home-post text-center">
                                <div class="post-thumb">
                                    <a href="./blog-single.html">
                                        <img src="{{asset('frontend/images/blog/1/2.jpg')}}" class="img-responsive" alt=""/>
                                        <div class="overlay-rmore fa fa-link"></div>
                                    </a>
                                </div>
                                <div class="post-excerpt">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <article class="home-post text-center">
                                <div class="post-thumb">
                                    <a href="./blog-single.html">
                                        <img src="{{asset('frontend/images/blog/1/3.jpg')}}" class="img-responsive" alt=""/>
                                        <div class="overlay-rmore fa fa-link"></div>
                                    </a>
                                </div>
                                <div class="post-excerpt">
