                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 widget-footer col-sm-3">
                            <h5>About Store</h5>
                            <img src="{{asset('frontend/images/basic/logo-lite.png')}}" class="img-responsive space10" alt=""/>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-5 col-sm-5">
                            <img src="{{asset('frontend/images/basic/payment.png')}}" class="pull-right img-responsive payment" alt=""/>
                        </div>
                    </div>
                </div>
            </div>	
