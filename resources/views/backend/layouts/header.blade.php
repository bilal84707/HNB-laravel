                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img
                              ...
                              src="{{asset('backend/assets/images/big/img1.jpg')}}"
                              alt="First slide"
                            />
                          </div>
                          <div class="carousel-item">
                            <img
                              class="d-block img-fluid"
                              src="{{asset('backend/assets/images/big/img2.jpg')}}"
                              alt="Second slide"
                            />
                          </div>
                          <div class="carousel-item">
                            <img
                              class="d-block img-fluid"
                              src="{{asset('backend/assets/images/big/img3.jpg')}}"
                              alt="Third slide"
                            />
                          </div>
                        </div>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                >
                  ...
                  <a class="dropdown-item" href="{{route('logging.out')}}"
                    ><i
